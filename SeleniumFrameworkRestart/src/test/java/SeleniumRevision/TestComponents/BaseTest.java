package SeleniumRevision.TestComponents;
...
import SeleniumRevision.POM.LandingPage;
...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\SeleniumRevision\\resources\\GlobalData.properties");
		prop.load(fis);
